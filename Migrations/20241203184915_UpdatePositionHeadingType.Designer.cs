...
namespace SincronizacionCoordenadas.Migrations
{
    ...
    [Migration("20241203184915_UpdatePositionHeadingType")]
    partial class UpdatePositionHeadingType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SincronizacionCoordenadas.Entity.Position", b =>
                {
                    b.HasOne("SincronizacionCoordenadas.Entity.VehicleTracking", "VehicleTracking")
                        .WithOne("Position")
                        .HasForeignKey("SincronizacionCoordenadas.Entity.Position", "VehicleTrackingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
